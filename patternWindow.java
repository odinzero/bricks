...
public class patternWindow {
    ...
    patternWindow(BRICKS mainBricks, String name,
        ...
        if(centerORnot)
          center(mainBricks.frame, window);
        else
          nonCenter(mainBricks.frame, x, y);   
...
//             super.paintComponent(g);
    ...
    public JLabel addContent(String str, int fontSize, int x, int y, int width, int height) {
