...
public class customLabel extends JLabel implements MouseListener {
    ...
    boolean call_tableOfRecords = false;
    BRICKS mainBricks;

    customLabel(String t, float al, BRICKS bricks) {
        text = t;
        alpha = al;
        mainBricks = bricks;
        text = t;
...
//        this.setVerticalTextPosition(SwingConstants.CENTER);
    ...
    public void callTableOfRecords(boolean call) {
        call_tableOfRecords = call;
    }

    public boolean getTableOfRecords() {
        return call_tableOfRecords;
    }
...
//        f.setVisible(true);
    ...
    public void mousePressed(MouseEvent e) {
        //callTableOfRecords(true);
        if (getTableOfRecords()) {
            //updateTable table = new updateTable(mainBricks);
            new tableOfRecords(mainBricks);
        }
    }
